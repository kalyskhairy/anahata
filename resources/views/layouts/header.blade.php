...
<head>
    ...
    <title>Anahata Villas and Spa Resorts</title>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"> <span class="nav-link"> Packages <i class="ti-angle-down"></i></span>
                        <ul class="dropdown-menu last">
                            <li class="dropdown-item"><a href="/honeymoon-packages">Honeymoon Packages</a></li>
                            <li class="dropdown-item"><a href="/yoga">Yoga</a></li>
                            <li class="dropdown-item"><a href="/spa">Spa</a></li>
                        </ul>
                    </li>
